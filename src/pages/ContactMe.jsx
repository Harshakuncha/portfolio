...
import profilePic from "../assets/harsha.jpg"; // place your image here

const ContactMe = () => {
  return (
    <>
      <Header />
      <div style={{ padding: "3rem 1rem", maxWidth: "1000px", margin: "auto" }}>
        <h2 style={{ textAlign: "center", fontSize: "2.5rem", marginBottom: "2rem", color: "#2c3e50" }}>
          Let's Connect
        </h2>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "2rem", justifyContent: "center" }}>
          ...
          <div style={{
            ...
            />
            <h3 style={{ marginBottom: "0.3rem" }}>Harsha Vardhan Reddy Kuncha</h3>
            <p style={{ color: "#777" }}>Tempe, Arizona</p>
            ...
            <div style={{ marginTop: "1.5rem", display: "flex", justifyContent: "center", gap: "1.2rem", flexWrap: "wrap" }}>
              ...
              <a href="https://www.github.com/harshakuncha/" target="_blank" rel="noreferrer">
                <i className="fa-brands fa-github fa-2x" style={{ color: "#000" }}></i>
              </a>
            </div>
          </div>
